...
int main(int argc, char * argv[])
{
  ...
  auto Sub3 = std::make_shared<Command>("Sub3", "CHAIN3_SUB_OUT", 3, 4, 248, false, executor); // 4
  ...
  auto Timer4 = std::make_shared<Sensor>("Timer4", "CHAIN4_TIMER_OUT", 4, 1, 364, 100ms, true, executor); // 5
