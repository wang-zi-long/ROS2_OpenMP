...
i = 4
while i < 9 :
    deafult = "/home/neu/Results/Cores_work/{}.log".format(i)
...
with open('/home/neu/Results/TXT/Cores.log', 'w') as file:
...
x_position  = [4, 5, 6, 7, 8]
x_posn_fmt  = [4, 5, 6, 7, 8]
...
plt.legend(bplot_4['boxes'],labels,loc='upper right', fontsize=12)  #绘制表示框，右下角绘制
plt.show()
...
#     plt.plot(x, cdf, label='Executor Thread number {0}'.format(i))
#     i += 1
...
# plt.legend()
# plt.savefig("/home/neu/Results/TEST/Cores.png", dpi=300)