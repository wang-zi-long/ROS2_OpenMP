...
file1  = "/home/neu/Desktop/OpenMP/results/Test2/DEFAULT.log"
file2  = "/home/neu/Desktop/OpenMP/results/Test2/OPENMP3.log"
file3  = "/home/neu/Desktop/OpenMP/results/Test2/OPENMP6.log"
...
print(np.average(openmp3))
print(np.average(openmp4))
print(np.average(openmp5))
print(np.average(openmp6))
...
openmp_1 = chain1_ltcy
openmp_2 = chain2_ltcy
openmp_3 = chain3_ltcy
openmp_4 = chain4_ltcy
openmp_5 = chain5_ltcy
openmp_6 = chain6_ltcy

chain1 = np.asarray([default1, openmp1, openmp_1], dtype=object)  
chain2 = np.asarray([default2, openmp2, openmp_2], dtype=object)
chain3 = np.asarray([default3, openmp3, openmp_3], dtype=object)
chain4 = np.asarray([default4, openmp4, openmp_4], dtype=object)
chain5 = np.asarray([default5, openmp5, openmp_5], dtype=object)
chain6 = np.asarray([default6, openmp6, openmp_6], dtype=object)

labels      = (["default", "openmp3", "openmp6"])
colors      = [(220/255.,237/255.,204/255.), (120/255.,214/255.,201/255.), (120/255.,214/255.,201/255.)]

bplot_1     = plt.boxplot(chain1, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(0, 0.25, 0.5),widths=0.2)
for patch, color in zip(bplot_1['boxes'], colors):
				patch.set_facecolor(color)
				patch.set(linewidth=0.5)
bplot_2     = plt.boxplot(chain2, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(1, 1.25, 1.5),widths=0.2)
for patch, color in zip(bplot_2['boxes'], colors):
				patch.set_facecolor(color)
				patch.set(linewidth=0.5)
bplot_3     = plt.boxplot(chain3, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(2, 2.25, 2.5),widths=0.2)
for patch, color in zip(bplot_3['boxes'], colors):
				patch.set_facecolor(color)
				patch.set(linewidth=0.5)
bplot_4     = plt.boxplot(chain4, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(3, 3.25, 3.5),widths=0.2)
for patch, color in zip(bplot_4['boxes'], colors):
				patch.set_facecolor(color)
				patch.set(linewidth=0.5)
bplot_5     = plt.boxplot(chain5, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(4, 4.25, 4.5),widths=0.2)
for patch, color in zip(bplot_5['boxes'], colors):
				patch.set_facecolor(color)
				patch.set(linewidth=0.5)
bplot_6     = plt.boxplot(chain6, patch_artist=True,labels=labels, showfliers=False, medianprops={'color':'black', 'linewidth':'1.2'}, positions=(5, 5.25,5.5),widths=0.2)
